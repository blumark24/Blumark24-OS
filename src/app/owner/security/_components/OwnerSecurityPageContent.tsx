...
// Pure CSS-only orbital diagram. No WebGL, no canvas, no external libs.
...
function OrbitMap({
  ...
  // 6 nodes pre-positioned around a centre (50%, 46%) at ~38% radius.
  // Angles: -90°(top), -30°, 30°, 90°(bottom), 150°, 210°
  const nodes = [
...
export default function OwnerSecurityPageContent() {
  ...
  return (
    <div className="relative max-w-6xl mx-auto space-y-7">
      ...
      {/* ── Digital Twin Risk Map + Risk Center ─────────────────────────────── */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-5">
        ...
        >
          <div className="px-5 pt-4 pb-1 flex items-center gap-2 border-b border-white/[0.04]">
            ...
            <span className="text-[10.5px] text-white/25 mr-auto">Digital Twin Risk Map</span>
          </div>
          <OrbitMap
