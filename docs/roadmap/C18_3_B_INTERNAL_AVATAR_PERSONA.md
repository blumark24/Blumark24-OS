...
This clean stage also restores the safe internal-office foundation currently needed in `main`:

- Existing interior asset registry.
- Internal office image in the fullscreen office view.
- Internal command panel.
- Safe text-room workspace.
- Safe open/close motion.
- Persona deck from scoped `officePeople` only.

## Persona behavior

The persona deck shows:
