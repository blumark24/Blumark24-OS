...
// Returns the latest 10 audit log entries enriched with owner_email / target_type
// for the bell dropdown, plus a flag for whether any entry is from the last 24 h.
